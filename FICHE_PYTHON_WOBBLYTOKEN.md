...
## Ce programme est à but éducatif il n'a pas pour but de prendre le role d'une vraie cryptomonnaie et d'être spéculé. Il est donc naturel que le code soit volontairement moins optimiser pour prioriser la lisibilité.
